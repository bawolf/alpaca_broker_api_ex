...
defmodule BrokerAPI.Model.Activity do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :activity_type => BrokerAPI.Model.ActivityType.t,
  ...
  def decode(value) do
    value
     |> Deserializer.deserialize(:activity_type, :struct, BrokerAPI.Model.ActivityType)
