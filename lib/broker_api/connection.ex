...
defmodule BrokerAPI.Connection do
  ...
  def middleware(options \\ []) do
    ...
    username =
      Keyword.get(options, :username, Application.get_env(:alpaca_broker_api, :api_client_id))

    password =
      Keyword.get(options, :password, Application.get_env(:alpaca_broker_api, :api_secret))
